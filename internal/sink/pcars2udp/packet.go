...
// Packet types as defined by pCars2 UDP protocol.
const (
	...
	headerSize          = 12
	telemetryPacketSize = 559
	gameStatePacketSize = 16
	timingsPacketSize   = 1063
)

// PacketHeader is the 12-byte common header for all pCars2 UDP packets.
